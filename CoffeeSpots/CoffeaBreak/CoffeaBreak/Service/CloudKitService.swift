...
extension CafeSpot {
    ...
    init(from record: CKRecord) throws {
        ...
        print("  imageName: \(record["imageName"] as? String ?? "NIL")")
        print("  rating: \(record["rating"] as? Double ?? -1)")
        print("  notes: \(record["notes"] as? String ?? "NIL")")
...
class CloudKitService {
    private let database = CKContainer(identifier: "iCloud.com.isidoro.CafeSpots").publicCloudDatabase
